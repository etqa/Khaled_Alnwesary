...
const Courses = () => {
  ...
  const courses = [
    ...
    {
      id: "blender-free-ext",
      title: t("courses.blender_free_ext.title"),
      description: t("courses.blender_free_ext.desc"),
      featured: false,
    ...
    {
      id: "d5-render-free",
      title: t("courses.d5_render_free.title"),
      description: t("courses.d5_render_free.desc"),
      featured: false,
    ...
    {
      id: "blender-free-int",
      title: t("courses.blender_free_int.title"),
      description: t("courses.blender_free_int.desc"),
      featured: false,
